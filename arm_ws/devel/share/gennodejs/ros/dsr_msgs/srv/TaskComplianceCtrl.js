...
class TaskComplianceCtrlRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type TaskComplianceCtrlRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type TaskComplianceCtrlRequest
    let len;
    let data = new TaskComplianceCtrlRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new TaskComplianceCtrlRequest(null);
...
class TaskComplianceCtrlResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.success = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type TaskComplianceCtrlResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type TaskComplianceCtrlResponse
    let len;
    let data = new TaskComplianceCtrlResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new TaskComplianceCtrlResponse(null);
...
module.exports = {
  Request: TaskComplianceCtrlRequest,
  Response: TaskComplianceCtrlResponse,
  md5sum() { return '13f8b8d245232e98ce000bd4e6262bcd'; },
  datatype() { return 'dsr_msgs/TaskComplianceCtrl'; }
};
