...
class GetDesiredVelxRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetDesiredVelxRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetDesiredVelxRequest
    let len;
    let data = new GetDesiredVelxRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetDesiredVelxRequest(null);
...
class GetDesiredVelxResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetDesiredVelxResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetDesiredVelxResponse
    let len;
    let data = new GetDesiredVelxResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetDesiredVelxResponse(null);
...
module.exports = {
  Request: GetDesiredVelxRequest,
  Response: GetDesiredVelxResponse,
  md5sum() { return '1ccbebbf66c48f74afb258f026a6daff'; },
  datatype() { return 'dsr_msgs/GetDesiredVelx'; }
};
