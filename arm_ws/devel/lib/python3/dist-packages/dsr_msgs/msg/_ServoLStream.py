...
"""autogenerated by genpy from dsr_msgs/ServoLStream.msg. Do not edit."""
import codecs
import sys
...
class ServoLStream(genpy.Message):
  _md5sum = "faef3261e269f88f638555affcbeea57"
  _type = "dsr_msgs/ServoLStream"
...
float64    time              # time"""
  ...
  _slot_types = ['float64[6]','float64[2]','float64[2]','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ServoLStream, self).__init__(*args, **kwds)
