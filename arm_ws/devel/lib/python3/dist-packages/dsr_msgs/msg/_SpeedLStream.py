...
"""autogenerated by genpy from dsr_msgs/SpeedLStream.msg. Do not edit."""
import codecs
import sys
...
class SpeedLStream(genpy.Message):
  _md5sum = "e46b9dfc7c2bf557dfdf28c9ac4104b9"
  _type = "dsr_msgs/SpeedLStream"
...
float64    time              # time"""
  ...
  _slot_types = ['float64[6]','float64[2]','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SpeedLStream, self).__init__(*args, **kwds)
