...
"""autogenerated by genpy from dsr_msgs/SetUserCartCoord2Request.msg. Do not edit."""
import codecs
import sys
...
class SetUserCartCoord2Request(genpy.Message):
  _md5sum = "b9f3dcf6a65143791504d0e9c825e501"
  _type = "dsr_msgs/SetUserCartCoord2Request"
...
"""
  __slots__ = ['x1','x2','x3','pos','ref']
  _slot_types = ['float64[6]','float64[6]','float64[6]','float64[6]','int8']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SetUserCartCoord2Request, self).__init__(*args, **kwds)
...
def _get_struct_b():
    ...
    return _struct_b
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from dsr_msgs/SetUserCartCoord2Response.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class SetUserCartCoord2Response(genpy.Message):
  _md5sum = "5845c23151db63ce4fa936d927189f8d"
  _type = "dsr_msgs/SetUserCartCoord2Response"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """int8    id                    # set user coord (101~200) or fail(-1) 
bool        success   
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SetUserCartCoord2Response, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.id is None:
        self.id = 0
...
def _get_struct_bB():
    ...
    return _struct_bB
class SetUserCartCoord2(object):
  _type          = 'dsr_msgs/SetUserCartCoord2'
  _md5sum = '42d11c6c94c1dfc41a37882dbd6da758'
  _request_class  = SetUserCartCoord2Request
  _response_class = SetUserCartCoord2Response
