...
"""autogenerated by genpy from dsr_msgs/SetUserCartCoord1Request.msg. Do not edit."""
import codecs
import sys
...
class SetUserCartCoord1Request(genpy.Message):
  _md5sum = "01a7d76771e91045d7b0913667745cf9"
  _type = "dsr_msgs/SetUserCartCoord1Request"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SetUserCartCoord1Request, self).__init__(*args, **kwds)
...
def _get_struct_b():
    ...
    return _struct_b
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from dsr_msgs/SetUserCartCoord1Response.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class SetUserCartCoord1Response(genpy.Message):
  _md5sum = "5845c23151db63ce4fa936d927189f8d"
  _type = "dsr_msgs/SetUserCartCoord1Response"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SetUserCartCoord1Response, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.id is None:
        self.id = 0
...
def _get_struct_bB():
    ...
    return _struct_bB
class SetUserCartCoord1(object):
  _type          = 'dsr_msgs/SetUserCartCoord1'
  _md5sum = '42b1d22dac70724bd7473cd4cc41f2c4'
  _request_class  = SetUserCartCoord1Request
  _response_class = SetUserCartCoord1Response
