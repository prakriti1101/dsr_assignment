...
"""autogenerated by genpy from dsr_msgs/FkinRequest.msg. Do not edit."""
import codecs
import sys
...
class FkinRequest(genpy.Message):
  _md5sum = "01a7d76771e91045d7b0913667745cf9"
  _type = "dsr_msgs/FkinRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FkinRequest, self).__init__(*args, **kwds)
...
def _get_struct_b():
    ...
    return _struct_b
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from dsr_msgs/FkinResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class FkinResponse(genpy.Message):
  _md5sum = "904a2ae76f71ef4190bde0122093ec1b"
  _type = "dsr_msgs/FkinResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FkinResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
...
class Fkin(object):
  _type          = 'dsr_msgs/Fkin'
  _md5sum = '26c14bd0ea35ff7d87f4f121a2ae40ac'
  _request_class  = FkinRequest
  _response_class = FkinResponse
