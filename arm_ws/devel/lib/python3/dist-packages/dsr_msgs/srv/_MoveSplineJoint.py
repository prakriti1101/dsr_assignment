...
"""autogenerated by genpy from dsr_msgs/MoveSplineJointRequest.msg. Do not edit."""
import codecs
import sys
...
class MoveSplineJointRequest(genpy.Message):
  _md5sum = "e1900c7787fce969908abb61dfa5501e"
  _type = "dsr_msgs/MoveSplineJointRequest"
...
uint32 stride  # stride of given dimension"""
  __slots__ = ['pos','posCnt','vel','acc','time','mode','syncType']
  _slot_types = ['std_msgs/Float64MultiArray[]','int8','float64[6]','float64[6]','float64','int8','int8']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       pos,posCnt,vel,acc,time,mode,syncType
    ...
    """
    if args or kwds:
      super(MoveSplineJointRequest, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_d2b().pack(_x.time, _x.mode, _x.syncType))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.time, _x.mode, _x.syncType,) = _get_struct_d2b().unpack(str[start:end])
      return self
...
def _get_struct_d2b():
    ...
    return _struct_d2b
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from dsr_msgs/MoveSplineJointResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class MoveSplineJointResponse(genpy.Message):
  _md5sum = "358e233cde0c8a8bcfea4ce193f8fc15"
  _type = "dsr_msgs/MoveSplineJointResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MoveSplineJointResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
...
def _get_struct_B():
    ...
    if _struct_B is None:
        _struct_B = struct.Struct("<B")
    return _struct_B
class MoveSplineJoint(object):
  _type          = 'dsr_msgs/MoveSplineJoint'
  _md5sum = '38e3ecc2960089549a21015a74e932c2'
  _request_class  = MoveSplineJointRequest
  _response_class = MoveSplineJointResponse
