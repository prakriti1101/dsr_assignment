...
"""autogenerated by genpy from dsr_msgs/MoveSplineTaskRequest.msg. Do not edit."""
import codecs
import sys
...
class MoveSplineTaskRequest(genpy.Message):
  _md5sum = "2d7f0e1b9d7d5f8de248622c84ca4d43"
  _type = "dsr_msgs/MoveSplineTaskRequest"
...
uint32 stride  # stride of given dimension"""
  __slots__ = ['pos','posCnt','vel','acc','time','ref','mode','opt','syncType']
  _slot_types = ['std_msgs/Float64MultiArray[]','int8','float64[2]','float64[2]','float64','int8','int8','int8','int8']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       pos,posCnt,vel,acc,time,ref,mode,opt,syncType
    ...
    """
    if args or kwds:
      super(MoveSplineTaskRequest, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_d4b().pack(_x.time, _x.ref, _x.mode, _x.opt, _x.syncType))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.time, _x.ref, _x.mode, _x.opt, _x.syncType,) = _get_struct_d4b().unpack(str[start:end])
      return self
...
def _get_struct_d4b():
    ...
    return _struct_d4b
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from dsr_msgs/MoveSplineTaskResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class MoveSplineTaskResponse(genpy.Message):
  _md5sum = "358e233cde0c8a8bcfea4ce193f8fc15"
  _type = "dsr_msgs/MoveSplineTaskResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MoveSplineTaskResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
...
def _get_struct_B():
    ...
    if _struct_B is None:
        _struct_B = struct.Struct("<B")
    return _struct_B
class MoveSplineTask(object):
  _type          = 'dsr_msgs/MoveSplineTask'
  _md5sum = '2d3a3ddb20aee3a3824c2674bb8b535d'
  _request_class  = MoveSplineTaskRequest
  _response_class = MoveSplineTaskResponse
